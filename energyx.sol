...
/**  
    Safe Energy ($EnergyX) The Deflationary Safe Energy Supporters Token...
    Hand to Hand for a better future!
     
    Key features:
    
    10% FEES PER TRANSACTION
    - 5% fee per transaction - burned forever
    - 5% fee per transaction - auto distributed to holders
    
    1,000,000,000,000,000 $EnergyX total supply (1 Quadrillion).
    
    BurnDrop Events 
    10% - will be burned forever to celebrate 100 holders
    10% - will be burned forever to celebrate 500 holders 
...
contract SafeEnergy is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Safe Energy';
    string  private constant _SYMBOL = 'EnergyX';
